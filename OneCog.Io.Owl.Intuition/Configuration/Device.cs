...
{
    public interface IDeviceSettings : Device.Settings.IProvider
    {
    ...
    {
        private Lazy<Device.Settings.IValues> _values;

        public DeviceSettings()
        {
            _values = new Lazy<Device.Settings.IValues>(ConstructValues);
        }

        private Device.Settings.IValues ConstructValues()
        {
        ...
        Device.Settings.IValues Device.Settings.IProvider.GetValues()
        {
